...
//                    worker.setTeamId(resultSet.getLong("teamId"));
//
//                    return worker;
//                }
//            }
...
//                psP.setLong(4, worker.getId());
//                psP.executeUpdate();
//
//                psW.setString(1, worker.getJobTitle());
//                psW.setDouble(2, worker.getSalary());
//                psW.setLong(3, worker.getTeamId());
//                psW.setLong(4, worker.getId());
//                psW.executeUpdate();
//
//                conn.commit();
